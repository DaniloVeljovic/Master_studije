...
public class ExtendedRecord implements Serializable {
    ...
    private final Integer testBool;

    public Integer getTestBool() {
        return testBool;
    }
    ...
    public ExtendedRecord(Builder builder) {
        ...
        this.testBool = builder.testBool;
    }
    ...
    public static class Builder {
        ...
        public Builder test(Double val) {
            this.test = val;
            return this;
        }

        public Builder testBool(Integer val) {
            this.testBool = val;
            return this;
        }
        ...
        public ExtendedRecord build() {
            return new ExtendedRecord(this);
        }
