...
Posle treniranja modela moguće je koristiti model za predikciju. Najjednostavnije je uzeti nekoliko instanci iz test skupa i videti kako model vrši predikciju za njih. Primer koda za testiranje skupa dat je na slici \ref{fig:fashion_mnist_test}.
...
Posle treniranja modela moguće je koristiti model za predikciju. Najjednostavnije je uzeti nekoliko instanci iz test skupa i videti kako model vrši predikciju za njih. Primer koda za testiranje skupa dat je na slici \ref{fig:test_logistic}.


\begin{wrapfigure}{c}{1\textwidth}
  \begin{center}
    \includegraphics[width=0.5\textwidth]{test_logistic}
  \end{center}
  \caption{Testiranje neuronske mreže Fashion MNIST skupom podataka}\label{fig:test_logistic}
\end{wrapfigure}
...
\begin{wrapfigure}[h]
    \includegraphics[width=0.5\textwidth]{test_logistic.png}
    \caption{Testiranje neuronske mreže Fashion MNIST skupom podataka}\label{fig:test_logistic}
\end{wrapfigure}
